...
import { updateImgClient } from "../../../../api/updateUsers/updateImgClient"; 
...
type authScreenProp = StackNavigationProp<RootParamList, 'AddProfileClient'>;

function AddProfileClient() {
    ...
    async function Upload({ uri, fileType }: { uri: any, fileType: any }) {
        ...
        const storageRef = ref(storage, "Client/Profile/" + `${id}`);
