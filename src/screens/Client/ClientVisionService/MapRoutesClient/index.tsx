...
type itemScreenParams = {
    professionalLocation: { latitudeClient: number; longitudeClient: number };
...
export function MapServiceClient() {
    ...
    const { professionalLocation, professionalName, itemName, itemPrice, image } = route.params as itemScreenParams; //localização da cliente
    ...
    useEffect(() => {
        watchPositionAsync(
            ...
            (response) => {
                ...
                if (location && professionalLocation) {

                    const clientCoordinates = {
                        latitude: professionalLocation.latitudeClient,
                        longitude: professionalLocation.longitudeClient
                    };
                ...
                >
                    ...
                    <Polyline
                        coordinates={[
                            ...
                            { latitude: professionalLocation.latitudeClient, longitude: professionalLocation.longitudeClient },
                        ]}
                        strokeColor="#000000"
                        strokeWidth={2}
                    />
