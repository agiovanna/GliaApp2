...
export const SmallButton = styled.TouchableOpacity`
  margin-right: 10px;
  padding: 5px;
  border: 1px rgba(232, 188, 185, 1);
  border-radius: 5px;
  font-size: 14px;
  flex-direction: row;
  align-items: center;
  background-color: rgba(232, 188, 185, 1);
`;
...
export function HomeClient({ navigation }: { navigation: any }) {
  ...
  {/*</View>*/}
      ...
      <AntDesign name="minus" size={28} color="black" />
        <Content>
          <Input type='primary' placeholder='Pesquise um profissional ou serviço'/>
          ...
          <ItemLista>
            ...
            <ClientItem>
              ...
              <ClientInfo>
                <ClientName>Nome do Profissional</ClientName>
                ...
                <ButtonsContainer>
                  ...
                  <SmallButton>
                  <FontAwesome5 name="car" size={16} color="black" />
                    <Text>2,5 km</Text>
                  </SmallButton>
                </ButtonsContainer>
